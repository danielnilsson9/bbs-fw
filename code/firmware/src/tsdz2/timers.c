...
void timer1_init_motor_pwm()
{
    ...
    // OC1
    TIM1->CCER1 |= (uint8_t)((uint8_t)(TIM1_OUTPUTSTATE_DISABLE & TIM1_CCER1_CC1E) |
    ...
    // OC2
    TIM1->CCER1 |= (uint8_t)((uint8_t)(TIM1_OUTPUTSTATE_DISABLE & TIM1_CCER1_CC2E) |
    ...
    TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OCIDLESTATE_RESET & TIM1_OISR_OIS2) |
    ...
    // OC3
    TIM1->CCER2 |= (uint8_t)((uint8_t)(TIM1_OUTPUTSTATE_DISABLE & TIM1_CCER2_CC3E) |
    ...
    TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OCIDLESTATE_RESET & TIM1_OISR_OIS3) |
    ...
    TIM1->CCER2 |= (uint8_t)((uint8_t)(TIM1_OUTPUTSTATE_DISABLE & TIM1_CCER2_CC4E) |
    ...
    TIM1->BKR = (uint8_t)(TIM1_OSSISTATE_ENABLE | TIM1_LOCKLEVEL_OFF | TIM1_BREAK_DISABLE | TIM1_BREAKPOLARITY_LOW |
