...
static const pt_t bbshd_ptc_lut[BBSHD_PTC_LUT_SIZE] = {
    {92100, -2000}, {96090, -1000}, {100000, 0000}, {103900, 1000}, {107790, 2000}, {109730, 2500}, {111670, 3000},
    {113610, 3500}, {115540, 4000}, {117470, 4500}, {119400, 5000}, {121320, 5500}, {123240, 6000}, {125160, 6500},
    {127080, 7000}, {128990, 7500}, {130900, 8000}, {132800, 8500}, {134710, 9000}, {136610, 9500}, {138510, 10000}};
...
static int16_t thermistor_ptc_bbshd_calculate_temperature(int32_t R_x100)
{
    ...
    return (uint16_t)MAP32(R_x100, bbshd_ptc_lut[i].x, bbshd_ptc_lut[i + 1].x, bbshd_ptc_lut[i].y,
                           bbshd_ptc_lut[i + 1].y);
}
#endif
