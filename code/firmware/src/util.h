...
#define MAP16(x, in_min, in_max, out_min, out_max)                                                                     \
    ((((int16_t)x) - (in_min)) * ((out_max) - (out_min)) / ((in_max) - (in_min)) + (out_min))
#define MAP32(x, in_min, in_max, out_min, out_max)                                                                     \
    ((((int32_t)x) - (in_min)) * ((out_max) - (out_min)) / ((in_max) - (in_min)) + (out_min))
