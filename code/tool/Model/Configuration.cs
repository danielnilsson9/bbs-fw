...
public class Configuration
{
    ...
    public void Validate()
    {
        ...
        for (int i = 0; i < StandardAssistLevels.Length; ++i)
        {
            ValidateLimits(StandardAssistLevels[i].MaxCurrentPercent, 0, 100,
                           $"Standard (Level {i}): Target Power (%)");
            ValidateLimits(StandardAssistLevels[i].MaxThrottlePercent, 0, 100,
                           $"Standard (Level {i}): Max Throttle (%)");
            ...
            ValidateLimits((uint)StandardAssistLevels[i].TorqueAmplificationFactor, 0, 25,
                           $"Standard (Level {i}): Torque Amplification");
        }
        ...
        for (int i = 0; i < SportAssistLevels.Length; ++i)
        {
            ...
            ValidateLimits((uint)SportAssistLevels[i].TorqueAmplificationFactor, 0, 25,
                           $"Sport (Level {i}): Torque Amplification");
        }
    }
