...
public static class DataGridExtension
{
    ...
    public static readonly DependencyProperty AutoScrollToEndProperty =
        DependencyProperty.RegisterAttached("AutoScrollToEnd", typeof(bool), typeof(DataGridExtension),
                                            new PropertyMetadata(default(bool), AutoScrollToEndChangedCallback));
    ...
    private static void AutoScrollToEndChangedCallback(DependencyObject dependencyObject,
