...
public class AssistLevelViewModel : ObservableObject
{
    ...
    public List<ValueItemViewModel<AssistBaseType>> AssistBaseTypeOptions {
        get;
    ...
    {
        get {
            var variants = new List<ValueItemViewModel<AssistPasVariant>> { new ValueItemViewModel<AssistPasVariant>(
                AssistPasVariant.Cadence, "Cadence") };
    ...
    {
        get {
            return _level.Type.HasFlag(Configuration.AssistFlagsType.Throttle);
        }
        set {
    ...
    {
        get {
            return _level.Type.HasFlag(Configuration.AssistFlagsType.CadenceOverride);
        }
        set {
    ...
    {
        get {
            return _level.Type.HasFlag(Configuration.AssistFlagsType.SpeedOverride);
        }
        set {
    ...
    {
        get {
            return _level.Type.HasFlag(Configuration.AssistFlagsType.PasVariable);
        }
    }
    ...
    {
        get {
            return _level.Type.HasFlag(Configuration.AssistFlagsType.PasTorque);
        }
    }
    ...
    {
        get {
            return _level.MaxCurrentPercent;
        }
        set {
    ...
    {
        get {
            return _level.MaxThrottlePercent;
        }
        set {
    ...
    {
        get {
            return _level.MaxCadencePercent;
        }
        set {
    ...
    {
        get {
            return _level.TorqueAmplificationFactor;
        }
        set {
    ...
    private static Configuration.AssistFlagsType ApplyBaseTypeFlag(AssistBaseType baseType,
                                                                   Configuration.AssistFlagsType flags)
    {
        byte f = (byte)flags;
        f &= (byte) ~(Configuration.AssistFlagsType.Pas | Configuration.AssistFlagsType.Throttle |
                      Configuration.AssistFlagsType.Cruise);
    ...
    private static Configuration.AssistFlagsType ApplyPasVariantFlag(AssistPasVariant pasVariant,
                                                                     Configuration.AssistFlagsType flags)
    {
    ...
    private static Configuration.AssistFlagsType ApplyThrottleCadenceOverrideFlag(bool enabled,
                                                                                  Configuration.AssistFlagsType flags)
    {
    ...
    private static Configuration.AssistFlagsType ApplyThrottleSpeedOverrideFlag(bool enabled,
                                                                                Configuration.AssistFlagsType flags)
    {
